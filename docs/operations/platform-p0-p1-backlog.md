...
| P0.8 | COMPLETE | compiled non-root API/Worker/Migrator images, exact-schema readiness, disabled Worker and graceful shutdown | clean 001→009, role/readiness failure modes, no-dev-dependency artifact and SIGTERM container tests |
