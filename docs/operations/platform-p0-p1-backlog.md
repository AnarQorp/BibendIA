...
| P0.3 | OPEN | memberships, platform grants, pilot capabilities; remove trust in `x-tenant-id` | multi-membership and scope-negative tests |
| P0.4 | OPEN | signed Twilio/ElevenLabs ingress, replay guard, Inbox and DID binding | invalid signature/replay/unknown-DID tests |
| P0.5 | OPEN | tenant lifecycle, suspension, fallback and kill switch | command, race and receipt tests |
