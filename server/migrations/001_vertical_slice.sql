...
GRANT USAGE ON SCHEMA public TO bibendia_api;
GRANT SELECT,INSERT,UPDATE,DELETE ON ALL TABLES IN SCHEMA public TO bibendia_api;
GRANT USAGE,SELECT ON ALL SEQUENCES IN SCHEMA public TO bibendia_api;
