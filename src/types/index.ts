...
export interface BibendiaUnderstanding {
  wants: string[];
  alreadyKnows: string[];
  missingInfo: string[];
  nextStep: string;
  autoActionNotice?: string;
  confidence?: 'high' | 'needs_confirmation';
  suggestedSlots?: { date: string; time: string; label: string; workload: string }[];
}
...
export interface Conversation {
  ...
  lastUpdate: string;
  messages: Message[];
  understanding: BibendiaUnderstanding;
}
...
export interface AiImpactLog {
  ...
  isRecovery?: boolean; // Only true if generated by follow-up conversion!
}
