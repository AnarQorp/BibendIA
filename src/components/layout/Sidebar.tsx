...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 bg-[#0f172a] text-slate-200 border-r border-slate-800 flex flex-col justify-between h-screen sticky top-0 z-30 select-none shadow-md">
      <div>
        {/* Brand Header */}
